        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-lg">
              We believe in the power of collaboration to achieve shared goals and create impactful solutions. Our partnerships play a crucial role in delivering comprehensive marketing strategies and top-tier services to our clients.
            </p>
          </div>
